...
cprequire_test(["inline:com-chilipeppr-widget-grbl-yg"], function (grbl) {
...
cpdefine("inline:com-chilipeppr-widget-grbl-yg", ["chilipeppr_ready", "jquerycookie"], function () {
    return {
        ...
        showBody: function(evt) {
            $('#com-chilipeppr-widget-grbl-yg .panel-body .stat-row').removeClass('hidden');
            $('#com-chilipeppr-widget-grbl-yg .hidebody span').addClass('glyphicon-chevron-up');
            $('#com-chilipeppr-widget-grbl-yg .hidebody span').removeClass('glyphicon-chevron-down');
            if ((evt !== null)) {
        ...
        hideBody: function(evt) {
            $('#com-chilipeppr-widget-grbl-yg .panel-body .stat-row').addClass('hidden');
            $('#com-chilipeppr-widget-grbl-yg .hidebody span').removeClass('glyphicon-chevron-up');
            $('#com-chilipeppr-widget-grbl-yg .hidebody span').addClass('glyphicon-chevron-down');
            if ((evt !== null)) {
        ...
        btnSetup: function() {
            // chevron hide body
            var that = this;
            $('#com-chilipeppr-widget-grbl-yg .hidebody').click(function(evt) {
                //console.log("GRBL: hide/unhide body");
                if ($('#com-chilipeppr-widget-grbl-yg .panel-body .stat-row').hasClass('hidden')) {
                    // it's hidden, unhide
                    that.showBody(evt);
                } else {
                    // hide
            ...
            $('#com-chilipeppr-widget-grbl-yg .grbl-feedhold').click(function() {
            ...
            $('#com-chilipeppr-widget-grbl-yg .grbl-cyclestart').click(function() {
            ...
            $('#com-chilipeppr-widget-grbl-yg .grbl-verbose').click(function() {
                //console.log("GRBL: manual status update");
                $('#com-chilipeppr-widget-grbl-yg .grbl-verbose').toggleClass("enabled");
            });
            
            $('#com-chilipeppr-widget-grbl-yg .grbl-reset').click(function() {
            ...
            $('#com-chilipeppr-widget-grbl-yg .btn-toolbar .btn').popover({
                delay: 500,
                animation: true,
                placement: "auto",
                trigger: "hover",
        ...
        closeController: function(isWithDelay) {
            ...
            this.version = "";
            $('#com-chilipeppr-widget-grbl-yg .panel-title').text("GRBL");
        ...
        grblResponse: function (recvline) {
            ...
            if (msg.indexOf("ok") >= 0 || msg.indexOf("error") >= 0) { //expected response
                ...
                if(msg.indexOf("PRB:") >= 0){
                    ...
                    $('#com-chilipeppr-widget-grbl-yg .panel-title').text("GRBL (" + this.version + ")"); //update ui  
                }
        ...
        forkSetup: function () {
            var topCssSelector = '#com-chilipeppr-widget-grbl-yg';
            ...
            chilipeppr.load("http://raw.githubusercontent.com/chilipeppr/widget-pubsubviewer/master/auto-generated-widget.html", function () {
                require(['inline:com-chilipeppr-elem-pubsubviewer'], function (pubsubviewer) {
                    pubsubviewer.attachTo($('#com-chilipeppr-widget-grbl-yg .panel-heading .dropdown-menu'), that);
                });
            });
